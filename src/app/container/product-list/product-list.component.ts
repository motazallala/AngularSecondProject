...
export class ProductListComponent {
  ...
  @Input()
  searchTextRes: string = '';
  countOfInStock: number = this.products.filter(
    (x) => x.is_in_inventory === true
  ).length;
  countOfOutOfStock: number = this.products.filter(
    (x) => x.is_in_inventory === false
  ).length;
